...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen text-white overflow-hidden relative">
      ...
      {/* User avatar menu — compact top-right, doesn't overlap with panel */}
      {user && (
      ...
      <div className="flex w-full h-screen relative z-10">
        ...
        <div className="flex-1 flex flex-col justify-end p-8 pb-12">
          <div className="max-w-2xl mx-auto w-full">
            <h1 className={`text-4xl font-light mb-8 transition-all duration-700 min-h-[48px] ${isListening ? 'text-indigo-300 scale-105 transform translate-y-[-10px] opacity-100' : isLoading ? '' : ''}`}>
              {isListening ? (
